...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { areacomun: @proyecto.areacomun, caracteristica: @proyecto.caracteristica, nombre: @proyecto.nombre, pisos: @proyecto.pisos, precio: @proyecto.precio, ubicacion: @proyecto.ubicacion } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { areacomun: @proyecto.areacomun, caracteristica: @proyecto.caracteristica, nombre: @proyecto.nombre, pisos: @proyecto.pisos, precio: @proyecto.precio, ubicacion: @proyecto.ubicacion } }
