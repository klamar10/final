...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { area: @departamento.area, estado: @departamento.estado, numero: @departamento.numero, piso: @departamento.piso, precio: @departamento.precio, proyecto_id: @departamento.proyecto_id, tipo: @departamento.tipo } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { area: @departamento.area, estado: @departamento.estado, numero: @departamento.numero, piso: @departamento.piso, precio: @departamento.precio, proyecto_id: @departamento.proyecto_id, tipo: @departamento.tipo } }
