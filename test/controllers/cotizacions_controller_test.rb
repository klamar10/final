...
class CotizacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cotizacion" do
    assert_difference('Cotizacion.count') do
      post cotizacions_url, params: { cotizacion: { comentarios: @cotizacion.comentarios, departamento_id: @cotizacion.departamento_id } }
    end
  ...
  test "should update cotizacion" do
    patch cotizacion_url(@cotizacion), params: { cotizacion: { comentarios: @cotizacion.comentarios, departamento_id: @cotizacion.departamento_id } }
