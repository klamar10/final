...
class PruebasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prueba" do
    assert_difference('Prueba.count') do
      post pruebas_url, params: { prueba: { apellido: @prueba.apellido, nombr: @prueba.nombr } }
    end
  ...
  test "should update prueba" do
    patch prueba_url(@prueba), params: { prueba: { apellido: @prueba.apellido, nombr: @prueba.nombr } }
